...
В данном файле находится main-функция нода компаса

\defgroup compass_node Компас
\brief Данный нод предназначен для инициализации соединения с компасом, 
корректного выключения, а так же получения данных от компаса и их публикации в сеть.
*/
